...
class DataController: NSObject {
    ...
    var userData = [
        User(name: "링고스타", userImage: UIImage(named: "Ling")!, kclPoint: 2800, userComment: "코더스 하이 만세", place: "메리츠"),
        User(name: "최은주", userImage: UIImage(named: "Pak")!, kclPoint: 102, userComment: "오늘 하루 힘드네요.", place: "메리츠"),
        User(name: "김효수", userImage: UIImage(named: "Kim")!, kclPoint: 54, userComment: "마지막까지 화이팅!", place: "메리츠"),
        User(name: "김태선", userImage: UIImage(named: "Park")!, kclPoint: 4798, userComment: "오늘 하루는 어떠셨나요? 다들 퇴근까지 화이팅이에요", place: "메리츠"),
        User(name: "이효종", userImage: UIImage(named: "Lee")!, kclPoint: 4321, userComment: "조금만 더하면 초롱님 따라 잡을 수 있을 듯! 후래아아입", place: "메리츠"),
        User(name: "김호선", userImage: UIImage(named: "Choi")!, kclPoint: 3612, userComment: "오늘도 화이팅팅", place: "메리츠"),
        User(name: "김태선", userImage: UIImage(named: "Park")!, kclPoint: 4798, userComment: "오늘 하루는 어떠셨나요? 다들 퇴근까지 화이팅이에요", place: "삼성"),
        User(name: "이효종", userImage: UIImage(named: "Lee")!, kclPoint: 4321, userComment: "조금만 더하면 초롱님 따라 잡을 수 있을 듯! 후래아아입", place: "삼성"),
        User(name: "김호선", userImage: UIImage(named: "Choi")!, kclPoint: 3612, userComment: "오늘도 화이팅팅", place: "삼성")
    ]
    
    var selectedPlace = "메리츠"
